...
EditMPCCueing::EditMPCCueing(QWidget *parent) :
    QMainWindow(parent)
{
    ui.setupUi(this);
}

EditMPCCueing::~EditMPCCueing()
{}
...
void EditMPCCueing::on_Cancel_clicked()
{
    this->close();
}

void EditMPCCueing::on_Apply_clicked()         //Writting function
{
...
void EditMPCCueing::on_OK_clicked()
{
    on_Apply_clicked();
    this->close();
}

void EditMPCCueing::on_PathButton_clicked()  // Change the file of parameters
{
